...
| [008-payment-system](./008-payment-system.md) | 課金システム（**9週間パッケージ・買い切り**） | 高 | 📝 設計完了 |
...
|------|------|
| Day 1-21（トライアル） | 無料 |
| Week 4-12（有料期間：9週間） | **¥19,800（一括払い・買い切り）** |

- Day 21: 継続選択時に9週間パッケージを購入
- **解約手続き不要**（サブスクではない）
- 9週間経過後にアクセス自動終了
- RevenueCat + App Store/Google Play IAP（Non-Renewing Subscription）
